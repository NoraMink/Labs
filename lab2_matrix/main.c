...
/** 
Reads matrix from text file first line contains matrix dimensions example: 3 3 
1 2 3 
4 5 6 
7 8 9 
*/ 
...
int main(int argc, char **argv) { 
 	...
 	if (!(m = mx_from_file(argv[1]))) {  	 	printf("Cannot read file %s\n", argv[1]); 
 	 	return -1; 
 	} 
 
 	mx_print(m);  	mx_det(m);  	return 0; 
}  
